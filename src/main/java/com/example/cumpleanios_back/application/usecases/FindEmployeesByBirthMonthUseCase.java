...
import java.util.List;
 @Service
public class FindEmployeesByBirthMonthUseCase {
    private final UserService userService;
    private final DateService dateService;

    public FindEmployeesByBirthMonthUseCase(UserService userService, DateService dateService) {
    ...
    public List<UserEntity> execute(LocalDate currentMonth) {
        ...
        return this.userService.findUsersBetweenPeriod(dateService.firstMonthDay(), dateService.lastMonthDay());
    }
}
